...
class GenerationConfig(models.Model):
    uploaded = models.ForeignKey(UploadedTrajectory, on_delete=models.CASCADE, related_name='generation_configs')
...
class GeneratedTrajectory(models.Model):
    ...
    config = models.ForeignKey(GenerationConfig, on_delete=models.CASCADE, related_name='generated_trajectories')
